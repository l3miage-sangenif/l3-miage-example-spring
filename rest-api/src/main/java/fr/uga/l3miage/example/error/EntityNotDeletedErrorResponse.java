 ...
 * </ul>
 */
@JsonTypeName(EntityNotDeletedErrorResponse.TYPE_NAME)
@ToString(callSuper = true, exclude = "errorCodeSwaggerDocumentation")
@EqualsAndHashCode(callSuper = true)
public class EntityNotDeletedErrorResponse extends ErrorResponse {
    /**
     * Match {@link ErrorCode#ENTITY_NOT_DELETED_ERROR}
     */
    protected static final String TYPE_NAME = "ENTITY_NOT_DELETED_ERROR";
    ...
    @Builder
    @Jacksonized
    public EntityNotDeletedErrorResponse(String uri, HttpStatus httpStatus, ErrorCode errorCode, String errorMessage) {
