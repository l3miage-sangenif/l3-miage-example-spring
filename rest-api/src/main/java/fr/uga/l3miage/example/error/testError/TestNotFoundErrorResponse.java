...
public class TestNotFoundErrorResponse extends ErrorResponse{
    /**
     * Match {@link ErrorCode#TEST_IS_NOT_FOUND}
     */
    protected static final String TYPE_NAME = "TEST_IS_NOT_FOUND";
    ...
    @Builder
    @Jacksonized
    public TestNotFoundErrorResponse(String uri, HttpStatus httpStatus, ErrorCode errorCode, String errorMessage, String description) {
