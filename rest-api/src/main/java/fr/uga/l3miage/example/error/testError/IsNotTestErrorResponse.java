package fr.uga.l3miage.example.error.testError;
 ...
 * </ul>
 */
@JsonTypeName(IsNotTestErrorResponse.TYPE_NAME)
@EqualsAndHashCode(callSuper = true)
@Getter
@ToString(callSuper = true, exclude = "errorCodeSwaggerDocumentation")
public class IsNotTestErrorResponse extends ErrorResponse{
    /**
     * Match {@link ErrorCode#IS_NOT_TEST_ERROR}
     */
    protected static final String TYPE_NAME = "IS_NOT_TEST_ERROR";
     ...
     * @param request correspond à la description utilisée qui est en doublon.
     */
    @Builder
    @Jacksonized
    public IsNotTestErrorResponse(String uri, HttpStatus httpStatus, ErrorCode errorCode, String errorMessage, CreateTestRequest request) {
