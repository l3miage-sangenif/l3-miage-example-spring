package fr.uga.l3miage.example.config.handler.testHandler;
...
@ControllerAdvice
@Slf4j
public class IsNotTestExceptionHandler {
     ...
     */
    @ExceptionHandler(IsNotTestRestException.class)
    public ResponseEntity<ErrorResponse> handle(HttpServletRequest httpServletRequest, Exception exception){
        IsNotTestRestException ex = (IsNotTestRestException) exception;
        final IsNotTestErrorResponse response = IsNotTestErrorResponse.builder()
