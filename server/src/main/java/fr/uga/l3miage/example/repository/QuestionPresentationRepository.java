 ...
 */
@Repository
public interface QuestionPresentationRepository extends JpaRepository<QuestionPresentationEntity, Integer> {
     ...
     */
    Optional<QuestionPresentationEntity> findByQuestionId(final Integer questionId);
